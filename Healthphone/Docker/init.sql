...
-- Insertar datos en la tabla tiposstatus
INSERT INTO tiposstatus (Nombre) VALUES 
('Activo'), 
('Inactivo'), 
('Suspendido');

-- Insertar datos en la tabla tipooperacion
INSERT INTO tipooperacion (Nombre) VALUES 
('Alta'), 
('Bajo'), 
('Medio');

-- Insertar datos en la tabla tipoescaneo
INSERT INTO tipoescaneo (Nombre) VALUES 
('Virus'), 
('Vulnerabilidades'), 
('Puertos');

-- Insertar datos en la tabla tipoclasificacion
INSERT INTO tipoclasificacion (Nombre) VALUES 
('Confidencial'), 
('Público'), 
('Interno');
...
INSERT INTO planes (Nombre, Descripcion, Costo, FechaFin, Disponibilidad, CantidadEscaneos) VALUES 
('Básico', 'Limitados', 50, '2025-12-31', 1, 10), 
('Avanzado', 'Llimitados', 150, '2026-12-31', 1, 100), 
('Empresarial', 'Múltiples', 500, '2027-12-31', 1, 500);
...
INSERT INTO operarios (Nombre, Telefono, Correo, idStatus) VALUES 
('Juan Pérez', 88912345, 'juan.perez@correo.com', 1), 
('Maria Gómez', 89871234, 'maria.gomez@correo.com', 1), 
('Carlos Rojas', 87004512, 'carlos.rojas@correo.com', 2);

-- Insertar datos en la tabla organizacion
INSERT INTO organizacion (Nombre, Telefono, Correo, idPais, Direccion) VALUES 
('Empresa X', '22334455', 'info@empresax.com', 1, 'San José, Costa Rica'), 
('Corp Y', '12345678', 'contacto@corpy.com', 2, 'California, USA'), 
('Compañía Z', '87654321', 'admin@companiaz.mx', 3, 'Ciudad de México, México');

-- Insertar datos en la tabla reglasclasificacion
INSERT INTO reglasclasificacion (idTipoClasificacion, idPlan, idTipoEscaneo) VALUES 
(1, 1, 1), 
(2, 2, 2), 
(3, 3, 3);

-- Insertar datos en la tabla sitios
INSERT INTO sitios (idOrganizacion, idReglaClasificacion, Nombre) VALUES 
(1, 1, 'Sitio A'), 
(2, 2, 'Sitio B'), 
(3, 3, 'Sitio C');

-- Insertar datos en la tabla suscripciones
INSERT INTO suscripciones (idPlan, idSitio, FechaInicio, FechaRenovacion, Activo, idStatus) VALUES 
(1, 1, '2023-01-01', '2024-01-01', 1, 1), 
(2, 2, '2023-06-01', '2024-06-01', 1, 1), 
(3, 3, '2023-07-01', '2024-07-01', 0, 2);

-- Insertar datos en la tabla escaneo
INSERT INTO escaneo (Escaneo_idTipoEscaneo, Escaneo_idSuscripcion, FechaEscaneo, Resultado, Escaneo_idStatus) VALUES 
(1, 1, '2024-01-10 14:00:00', 'No se encontraron amenazas', 1), 
(2, 2, '2024-06-15 10:30:00', 'Vulnerabilidades encontradas', 2), 
(3, 3, '2024-07-20 12:45:00', 'Puerto 22 abierto', 1);

-- Insertar datos en la tabla plan_tipoescaneo
INSERT INTO plan_tipoescaneo (idPlan, idTipoEscaneo) VALUES 
(1, 1), 
(2, 2), 
(3, 3);

-- Insertar datos en la tabla pagos
INSERT INTO pagos (idOrganizacion, idSuscripcion, Monto, FechaPago, idMetodoPago, idStatus) VALUES 
(1, 1, 50, '2023-01-15', 1, 1), 
(2, 2, 150, '2023-06-10', 2, 1), 
(3, 3, 500, '2023-07-05', 3, 2);

-- Insertar datos en la tabla bitacoraescaneo
INSERT INTO bitacoraescaneo (Bitacora_idSitio, Bitacora_idOperario, Bitacora_idEscaneo, Bitacora_idOperacion, FechaEscaneo, ResultadoAnterior, ResultadoNuevo) VALUES 
(1, 1, 1, 1, '2024-01-11 14:30:00', 'No se encontraron amenazas', 'Amenazas menores detectadas'), 
(2, 2, 2, 2, '2024-06-16 11:00:00', 'Vulnerabilidades encontradas', 'Parcialmente resueltas'), 
(3, 3, 3, 3, '2024-07-21 13:00:00', 'Puerto 22 abierto', 'Puerto cerrado');
...
JOIN 
    reglasclasificacion r ON p.idPlanes = r.idPlan
JOIN 
